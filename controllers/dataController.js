...
const getData =async (req, res) => {
  ...
  module.exports = { getData,filterByYear,filterByTopic,filterByTitle,filterByCountry,filterByRegion,filterBySector,filterByPestle,filterBySource,filterByIntensity,filterByLikelyhood };